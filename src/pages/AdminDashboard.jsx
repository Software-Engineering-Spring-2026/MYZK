...
const SEEDED_USERS = [
  ...
  },
  {
    ...
    email: "hr@instabug.com",
    password: "instabug123",
    role: "employer",
    status: "pending",
    active: true,
    taxDocument: "instabug-tax-card-2026.pdf",
    companyBio: "Instabug is a bug reporting and crash reporting platform used by mobile teams worldwide. We actively hire GUC students for internship and full-time positions.",
    address: "Cairo Festival City, New Cairo",
    contactInfo: "hr@instabug.com | +20 2 0000 0001",
  },
  {
    id: "emp-2",
    companyName: "Breadfast",
    email: "talent@breadfast.com",
    password: "breadfast123",
    role: "employer",
    status: "accepted",
    active: true,
    taxDocument: "breadfast-commercial-register.pdf",
    companyBio: "Breadfast is Egypt's fastest-growing on-demand grocery delivery platform. We build robust backend systems and data pipelines to power same-hour delivery across Cairo.",
    address: "Heliopolis, Cairo",
    contactInfo: "talent@breadfast.com | +20 2 0000 0002",
  },
  {
    id: "stu-1",
    firstName: "Layla",
    ...
    linkedin: "linkedin.com/in/layla-hassan",
  },
  {
    id: "stu-2",
    firstName: "Omar",
    ...
    skills: ["Java", "Spring Boot", "SQL", "Arduino"],
  },
  {
    id: "stu-3",
    firstName: "Nour",
    lastName: "Sherif",
    email: "nour.sherif@student.guc.edu.eg",
    password: "nour123",
    role: "student",
    status: "accepted",
    active: true,
  ...
  },
  {
    ...
    active: true,
    major: "Computer Science",
    skills: ["Flutter", "Firebase", "Dart", "React Native"],
  },
  {
    id: "ins-1",
    firstName: "Rania",
    lastName: "Mansour",
    email: "rania.mansour@guc.edu.eg",
    password: "rania123",
    role: "instructor",
    status: "accepted",
    active: true,
    biography: "Dr. Rania Mansour is a senior lecturer in Software Engineering and supervises Bachelor Project teams focused on full-stack and product development.",
    courses: ["Bachelor Project", "Software Engineering"],
  },
  {
    id: "ins-2",
    firstName: "Tarek",
    lastName: "Sobhy",
    email: "tarek.sobhy@guc.edu.eg",
    password: "tarek123",
    role: "instructor",
    status: "accepted",
    active: true,
    biography: "Dr. Tarek Sobhy teaches Database Systems and Operating Systems. His research focuses on distributed query optimization and storage engines.",
  ...
  },
  {
    ...
    firstName: "Hana",
    lastName: "Elgazzar",
    email: "hana.elgazzar@guc.edu.eg",
    password: "hana123",
    role: "instructor",
    status: "accepted",
    active: true,
    biography: "Dr. Hana Elgazzar leads the Machine Learning track and supervises research projects in NLP, computer vision, and applied deep learning.",
...
const SEEDED_PROJECTS = [
  {
    ...
    description:
      "A full-stack web app that lets GUC students report lost items and claim found ones with real-time notifications.",
    course: "Bachelor Project",
    courseInstructor: "Rania Mansour",
  ...
  },
  {
    ...
    description:
      "An IoT system using soil-moisture sensors and an Arduino controller to automate irrigation scheduling.",
    course: "Embedded Systems",
    courseInstructor: "Mostafa Aly",
    creatorId: "omar.farouk@student.guc.edu.eg",
    ...
    flagged: false,
    isPublic: true,
    tags: ["Java", "Arduino", "IoT"],
  },
  {
    id: "project-seeded-3",
    title: "Arabic Sentiment Analyzer",
    description:
      "A fine-tuned transformer model for multi-class sentiment analysis on Arabic social media text.",
    course: "Machine Learning",
    courseInstructor: "Hana Elgazzar",
    creatorId: "nour.sherif@student.guc.edu.eg",
    creatorName: "Nour Sherif",
    createdAt: "2026-04-05",
    rating: 4,
    active: true,
    flagged: true,
    flagReason: "Similarity detected in methodology section",
    appeal: "The methodology section follows the course-provided template distributed by the instructor.",
    isPublic: true,
    tags: ["Python", "PyTorch", "NLP"],
  },
  {
    id: "project-seeded-4",
    title: "GUC Room Booking App",
    description:
      "A Flutter mobile app for reserving study rooms and labs on campus with live availability.",
    course: "Mobile Application Development",
    courseInstructor: "Karim Wahba",
    creatorId: "youssef.khaled@student.guc.edu.eg",
    creatorName: "Youssef Khaled",
  ...
  {
    id: "project-seeded-5",
    title: "Campus Clinic Scheduler",
    description:
      "A web portal for booking appointments at the GUC clinic with doctor availability and SMS reminders.",
    course: "Database Systems",
    courseInstructor: "Tarek Sobhy",
    creatorId: "layla.hassan@student.guc.edu.eg",
    creatorName: "Layla Hassan",
...
const SEEDED_INTERNSHIP_STATS = [
  {
    ...
    completedStudents: 7,
    timeline: [
      { period: "Summer 2025", count: 1 },
      { period: "Winter 2026", count: 1 },
    ],
  },
  {
    companyName: "VOIS",
    internshipsOffered: 1,
    completedStudents: 4,
    timeline: [
      { period: "Summer 2025", count: 1 },
    ],
...
const SEEDED_COURSES = [
  ...
  { id: "course-4", courseName: "Operating Systems", courseCode: "CSEN 602" },
  { id: "course-5", courseName: "Machine Learning", courseCode: "CSEN 702" },
];

const SEEDED_COURSE_REQUESTS = [
  {
    id: "request-1",
    instructorName: "Rania Mansour",
    instructorEmail: "rania.mansour@guc.edu.eg",
  ...
  {
    id: "request-2",
    instructorName: "Tarek Sobhy",
    instructorEmail: "tarek.sobhy@guc.edu.eg",
...
const SEEDED_ALERTS = [
  {
    ...
    message: "Instabug uploaded a tax certificate and is awaiting admin review.",
    read: false,
  ...
  },
  {
    ...
    message: "Arabic Sentiment Analyzer has an appeal attached to its academic flag.",
    read: false,
...
function AdminDashboard() {
  ...
  const decideCourseRequest = (request, status) => {
    ...
    if (status === 'accepted') {
      const email = request.instructorEmail;
      const saved = JSON.parse(localStorage.getItem(`courses_${email}`) || '[]');
      const updated = request.type === 'link'
        ? saved.includes(request.courseName) ? saved : [...saved, request.courseName]
        : saved.filter(c => c !== request.courseName);
      localStorage.setItem(`courses_${email}`, JSON.stringify(updated));
    }

    const msg = status === 'accepted'
      ? `Your request to ${request.type} course "${request.courseName}" has been approved by the admin.`
      : `Your request to ${request.type} course "${request.courseName}" has been rejected by the admin.`;
    const notifs = JSON.parse(localStorage.getItem('notifications') || '[]');
    notifs.push({ id: Date.now().toString(), userId: request.instructorEmail, message: msg, read: false, createdAt: new Date().toISOString() });
